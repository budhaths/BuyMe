...
/**
 * Servlet implementation class customerRepHandler
 */
@WebServlet("/customerRepHandler")
public class customerRepHandler extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   String user_name="support";
		List<Mail> mail_list= getMail(user_name);
		request.setAttribute("mail_ll", mail_list);
		
		RequestDispatcher rs = request.getRequestDispatcher("customer_rep_portal.jsp");
